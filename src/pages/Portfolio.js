    ...
    return (
      <div style={{marginBottom: "10px", marginTop: "10px"}}>
        ...
        <Row >
          ...
          <Col style={{minWidth: "318px"}} lg="4" md="6" s="9"><Project title="GifTastic" url="https://rbrodefrank.github.io/GifTastic/" git="https://github.com/rbrodefrank/GifTastic" image={GifTastic} discription="Gif Tastic is a website app that retreives Gifs from Giphy using the Giphy API." /></Col>
          ...
          <Col style={{minWidth: "318px"}} lg="4" md="6" s="9"><Project title="Word Guess Game" url="https://rbrodefrank.github.io/Word-Guess-Game/" git="https://github.com/rbrodefrank/Word-Guess-Game" image={WordGuess} discription="A simple Word Guessing Game with a fantasy creature theme." /></Col>          
          <Col style={{minWidth: "318px"}} lg="4" md="6" s="9"></Col>
        </Row>
      </div>
    );
  }
